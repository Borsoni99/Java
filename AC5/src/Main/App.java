...
public class App {
    ...
    public static void carregarDados(AlunoCRUD alunoCRUD) {
        try {
            FileReader fileReader = new FileReader("C:/Users/thiag/Downloads/Java-main/Java-main/AC5/src/alunos.txt");
    ...
    try {
        FileWriter fileWriter = new FileWriter("C:/Users/thiag/Downloads/Java-main/Java-main/AC5/src/alunos.txt");
